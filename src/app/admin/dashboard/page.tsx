...
//     useEffect(() => {
//         void loadAdminDashboard({ showLoading: false });
//     }, []);

//     const userGrowth = data ? getUserGrowth(data.users) : null;
//     const adminShare = data && data.stats.totalUsers > 0
//         ? Math.round((data.stats.admins / data.stats.totalUsers) * 100)
//         : 0;
...
//                                                 Privacy-safe account insights without listing user names or emails.
//                                             </p>
//                                         </div>
...
//                                         <OverviewMetric
//                                             label="New This Week"
//                                             value={String(userGrowth?.last7Days ?? 0)}
//                                             helper="Accounts created in the last 7 days"
//                                         />
//                                         <OverviewMetric
//                                             label="New This Month"
//                                             value={String(userGrowth?.last30Days ?? 0)}
//                                             helper="Accounts created in the last 30 days"
//                                         />
//                                         <OverviewMetric
//                                             label="Admin Ratio"
//                                             value={`${adminShare}%`}
//                                             helper={`${data.stats.admins} admins, ${data.stats.members} members`}
//                                         />
//                                     </div>
...
//                                     <div className="mt-5 space-y-3">
//                                         <ChecklistItem text="Review new member access weekly" />
//                                         <ChecklistItem text="Check Gmail sync and reply queues" />
//                                         <ChecklistItem text="Keep admin accounts limited" />
//                                     </div>
//                                 </article>
//                             </section>
...
//                                     description="Monitor synced inbox volume and keep email processing healthy."
//                                     value={`${data.stats.emails} emails`}
//                                     icon={Inbox}
//                                 />
//                                 <FeatureCard
//                                     title="AI Reply Queue"
//                                     description="Track generated replies and review automation output quality."
//                                     value={`${data.stats.aiReplies} replies`}
//                                     icon={Bot}
//                                 />
//                                 <FeatureCard
//                                     title="Task Pipeline"
//                                     description="Watch task volume and jump into task management when needed."
//                                     value={`${data.stats.tasks} tasks`}
//                                     icon={ListChecks}
//                                 />
//                             </section>
//                         </>
...
//             <span className="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-50 text-sm font-bold text-emerald-700">
//                 ✓
//             </span>
...
// function getUserGrowth(users: AdminDashboardData["users"]) {
//     const now = Date.now();
                    ...
                    {isLoading ? (
                        ...
                        <>
                            <section className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
                                <AdminStat title="Total Users" value={data.stats.totalUsers} icon={Users} />
                                <AdminStat title="Admins" value={data.stats.admins} icon={ShieldCheck} />
                                <AdminStat title="Members" value={data.stats.members} icon={Users} />
                                <AdminStat title="Emails" value={data.stats.emails} icon={Inbox} />
                                <AdminStat title="AI Replies" value={data.stats.aiReplies} icon={Bot} />
                                <AdminStat title="Tasks" value={data.stats.tasks} icon={ListChecks} />
                            </section>
