...
// // //                 setReplyCount(typeof data.count === "number" ? data.count : 0);
// // //             } catch (error) {
...
// // //                         >
// // //                             {replyCount} course draft AI repl
// // //                             {replyCount === 1 ? "y" : "ies"} ready. Click to review.
// // //                         </button>
// // //                     ) : null}
...
//             const data = await response.json();
//             const loggedIn = response.ok && !!data.user;
...
//     function goToLogin(next = "/dashboard") {
...
//         if (!loggedIn) {
//             goToLogin("/replies?courseOnly=true");
//             return;
//         }

//         window.location.href = "/replies?courseOnly=true";
//     }
...
//                     className="rounded-full bg-emerald-800 px-5 py-3 text-sm font-semibold text-white shadow-xl hover:bg-emerald-900"
//                 >
//                     Login to use Email Bot 🤖
//                 </button>
//             </div>
//         );
//     }
